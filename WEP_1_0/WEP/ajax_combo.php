...
*/
	...
	$lookups = array(   
		...
		'ss_view_product_featured' => array(   
			'post_id' => array(
				'parent_table' => 'ss_view_product_description',
				'parent_pk_field' => 'post_id',
				'parent_caption' => '`ss_view_product_description`.`post_id`',
				'parent_from' => '`ss_view_product_description` ',
				'filterers' => array(),
				'custom_query' => '',
