<?php
	...
	$schema = array(   
		'ss_view_product_description' => array(   
			'post_id' => array('appgini' => 'BIGINT(20) unsigned not null primary key default \'0\' '),
			'title' => array('appgini' => 'TEXT '),
			'excerpt' => array('appgini' => 'TEXT '),
			'post_status' => array('appgini' => 'VARCHAR(20) default \'publish\' ')
		),
		'ss_view_product_featured' => array(   
			'post_id' => array('appgini' => 'BIGINT(20) unsigned default \'0\' '),
			'featured' => array('appgini' => 'LONGTEXT '),
			'id' => array('appgini' => 'BIGINT(20) unsigned not null primary key ')
		),
		'ss_view_product_price' => array(   
			'post_id' => array('appgini' => 'BIGINT(20) unsigned default \'0\' '),
			'price' => array('appgini' => 'LONGTEXT '),
			'id' => array('appgini' => 'BIGINT(20) unsigned not null primary key ')
		),
		'ss_view_product_regular_price' => array(   
			'post_id' => array('appgini' => 'BIGINT(20) unsigned default \'0\' '),
			'regular_price' => array('appgini' => 'LONGTEXT '),
			'id' => array('appgini' => 'BIGINT(20) unsigned not null primary key ')
		),
		'ss_view_product_sale_price' => array(   
			'post_id' => array('appgini' => 'BIGINT(20) unsigned default \'0\' '),
			'sale_price' => array('appgini' => 'LONGTEXT '),
			'id' => array('appgini' => 'BIGINT(20) unsigned not null primary key ')
		),
		'ss_view_product_sale_price_dates_from' => array(   
			'post_id' => array('appgini' => 'BIGINT(20) unsigned default \'0\' '),
			'sale_price_dates_from' => array('appgini' => 'DATE '),
			'id' => array('appgini' => 'BIGINT(20) unsigned not null primary key ')
		),
		'ss_view_product_sale_price_dates_to' => array(   
			'post_id' => array('appgini' => 'BIGINT(20) unsigned default \'0\' '),
			'sale_price_dates_to' => array('appgini' => 'DATE '),
			'id' => array('appgini' => 'BIGINT(20) unsigned not null primary key ')
		),
		'ss_view_product_sku' => array(   
			'post_id' => array('appgini' => 'BIGINT(20) unsigned default \'0\' '),
			'sku' => array('appgini' => 'LONGTEXT '),
			'id' => array('appgini' => 'BIGINT(20) unsigned not null primary key ')
		)
	);
