				...
				<table class="table">
					...
					<tr>
						<td align="center">
							Show records from
							<?php
								$arrFields=array('', 'ss_view_product_description', 'ss_view_product_featured', 'ss_view_product_price', 'ss_view_product_regular_price', 'ss_view_product_sale_price', 'ss_view_product_sale_price_dates_from', 'ss_view_product_sale_price_dates_to', 'ss_view_product_sku');
								$arrFieldCaptions=array('All tables', 'WooCommerce Edit Prices', 'Product Featured', 'Product Price', 'Product regular price', 'Product sale price', 'Product sale price dates from', 'Product sale price dates to', 'Product Sku');
