	...
	<?php
		...
		if(is_array($arrTables)){
			...
			foreach($arrTables as $tn=>$tc){
				...
				$tChkHL = array_search($tn, array('ss_view_product_featured','ss_view_product_price','ss_view_product_regular_price','ss_view_product_sale_price','ss_view_product_sale_price_dates_from','ss_view_product_sale_price_dates_to','ss_view_product_sku'));
