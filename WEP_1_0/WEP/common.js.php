...
jQuery(function(){
	...
	/* don't allow responsive images to exceed their actual dimensions */
...
function ss_view_product_description_validateData(){
	if($('post_id').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> post_id", close: function(){ jQuery('#post_id').focus(); } }); return false; };
	return true;
}
function ss_view_product_featured_validateData(){
	if($('id').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> ID", close: function(){ jQuery('#id').focus(); } }); return false; };
	return true;
}
function ss_view_product_price_validateData(){
	if($('id').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Id", close: function(){ jQuery('#id').focus(); } }); return false; };
	return true;
}
function ss_view_product_regular_price_validateData(){
	if($('id').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Id", close: function(){ jQuery('#id').focus(); } }); return false; };
	return true;
}
function ss_view_product_sale_price_validateData(){
	if($('id').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Id", close: function(){ jQuery('#id').focus(); } }); return false; };
	return true;
}
function ss_view_product_sale_price_dates_from_validateData(){
	if($('id').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Id", close: function(){ jQuery('#id').focus(); } }); return false; };
	return true;
}
function ss_view_product_sale_price_dates_to_validateData(){
	if($('id').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Id", close: function(){ jQuery('#id').focus(); } }); return false; };
	return true;
}
function ss_view_product_sku_validateData(){
	if($('id').value == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Id", close: function(){ jQuery('#id').focus(); } }); return false; };
	return true;
}
