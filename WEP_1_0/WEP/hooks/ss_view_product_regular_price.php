<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ss_view_product_regular_price' table. 
	...
	*/
	...
	function ss_view_product_regular_price_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_regular_price_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function ss_view_product_regular_price_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function ss_view_product_regular_price_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['post_id'], $data['regular_price']
	...
	*/
	...
	function ss_view_product_regular_price_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_regular_price_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['post_id'], $data['regular_price'], $data['id']
	...
	*/
	...
	function ss_view_product_regular_price_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_regular_price_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_regular_price_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_regular_price_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function ss_view_product_regular_price_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_regular_price_batch_actions(&$args){
