<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ss_view_product_description' table. 
	...
	*/
	...
	function ss_view_product_description_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_description_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function ss_view_product_description_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['title'], $data['excerpt'], $data['post_status']
	...
	*/
	...
	function ss_view_product_description_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_description_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_description_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['post_id'], $data['title'], $data['excerpt'], $data['post_status']
	...
	*/
	...
	function ss_view_product_description_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_description_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_description_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_description_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function ss_view_product_description_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_description_batch_actions(&$args){
