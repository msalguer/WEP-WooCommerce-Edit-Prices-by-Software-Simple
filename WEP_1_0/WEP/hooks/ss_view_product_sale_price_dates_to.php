<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ss_view_product_sale_price_dates_to' table. 
	...
	*/
	...
	function ss_view_product_sale_price_dates_to_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_dates_to_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function ss_view_product_sale_price_dates_to_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function ss_view_product_sale_price_dates_to_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['post_id'], $data['sale_price_dates_to']
	...
	*/
	...
	function ss_view_product_sale_price_dates_to_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_dates_to_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['post_id'], $data['sale_price_dates_to'], $data['id']
	...
	*/
	...
	function ss_view_product_sale_price_dates_to_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_dates_to_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_dates_to_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_dates_to_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_dates_to_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_dates_to_batch_actions(&$args){
