<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ss_view_product_sale_price' table. 
	...
	*/
	...
	function ss_view_product_sale_price_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function ss_view_product_sale_price_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function ss_view_product_sale_price_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['post_id'], $data['sale_price'], $data['id']
	...
	*/
	...
	function ss_view_product_sale_price_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function ss_view_product_sale_price_batch_actions(&$args){
